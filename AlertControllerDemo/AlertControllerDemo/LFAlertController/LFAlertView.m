...
@interface LFAlertAction ()

@property (nonatomic,strong) NSString *title;
@property (nonatomic,assign) LFAlertActionStyle style;
@property (nonatomic,copy) void(^handler)(LFAlertAction *);

@end

@implementation LFAlertAction

+ (instancetype)actionWithTitle:(NSString *)title style:(LFAlertActionStyle)style handler:(void (^)(LFAlertAction *))handler {
    return [[self alloc] initWithTitle:title style:style handler:handler];
}


- (instancetype) initWithTitle:(NSString *)title style:(LFAlertActionStyle)style handler:(void (^)(LFAlertAction *))handler {
    self = [super init];
    if (self) {
        _title = title;
        _style = style;
...
- (id)copyWithZone:(NSZone *)zone {
    LFAlertAction *action = [[self class] allocWithZone:zone];
...
- (UIColor *)buttonBgColorWithStyle:(LFAlertActionStyle)style
{
    switch (style) {
        case LFAlertActionStyleDefault:
            return _buttonDefaultBgColor;
        case LFAlertActionStyleCancel:
            return _buttonCancelBgColor;
        case LFAlertActionStyleDestructive:
...
{
    LFAlertAction *action = _actions[button.tag - kButtonTagOffset];
