...
@interface LFAlertController ()

@property (nonatomic, strong) UIView *alertView;

@property (nonatomic, assign) LFAlertControllerStyle preferredStyle;

@property (nonatomic, assign) LFAlertTransitionAnimation transitionAnimation;
...
- (instancetype)initWithAlertView:(UIView *)alertView preferredStyle:(LFAlertControllerStyle)preferredStyle transitionAnimation:(LFAlertTransitionAnimation)transitionAnimation transitionAnimationClass:(Class)transitionAnimationClass
{
...
+ (instancetype)alertControllerWithAlertView:(UIView *)alertView
{
    return [[self alloc]initWithAlertView:alertView
                           preferredStyle:LFAlertControllerStyleAlert
                      transitionAnimation:LFAlertTransitionAnimationFade
...
+ (instancetype)alertControllerWithAlertView:(UIView *)alertView preferredStyle:(LFAlertControllerStyle)preferredStyle transitionAnimationClass:(Class)transitionAnimationClass
{
    return [[self alloc]initWithAlertView:alertView
                           preferredStyle:preferredStyle
                      transitionAnimation:LFAlertTransitionAnimationCustom
...
- (void)viewDidLoad {
    ...
    if (_preferredStyle == LFAlertControllerStyleAlert) {
